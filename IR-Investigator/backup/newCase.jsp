				...
				<div class="box">
					...
					<form action="" method="post">
						...
						<div class="form">
								<p>
									<span class="req"></span>
									<label>Case ID <span>*</span></label>
									<input type="text" class="field size1" />
								</p>
								<p>
									<span class="req"></span>
									<label>Case Name <span>*</span></label>
									<input type="text" class="field size1" />
								</p>	
								...
								<p>
									<span class="req"></span>
									<label>Case Description <span>*</span></label>
									<textarea class="field size1" rows="10" cols="30"></textarea>
								</p>	
								<p class="inline-field">
									<label>Evidence</label>
									<select class="field size3">
										<option value="">Autorun</option>
										<option value="">Winaudit</option>
									</select>
									<input type="button" class="field size3" value="Browse">
								</p>
						<a href="#" class="add-button"><span>Add new Tool</span></a>
						<div class="cl">&nbsp;</div>
